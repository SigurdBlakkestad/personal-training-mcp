...
class Activity(Base):
    ...
    vo2_max: Mapped[float | None] = mapped_column(REAL)
    ...
    min_hr: Mapped[int | None] = mapped_column(SmallInteger)
    max_power: Mapped[int | None] = mapped_column(SmallInteger)
    avg_stride_length_cm: Mapped[float | None] = mapped_column(REAL)
    avg_ground_contact_time_ms: Mapped[int | None] = mapped_column(Integer)
    moving_time_seconds: Mapped[int | None] = mapped_column(Integer)
    suffer_score: Mapped[int | None] = mapped_column(SmallInteger)
    is_trainer: Mapped[bool | None] = mapped_column(Boolean)
    kilojoules: Mapped[float | None] = mapped_column(REAL)
    average_speed_ms: Mapped[float | None] = mapped_column(REAL)
    workout_type: Mapped[int | None] = mapped_column(SmallInteger)
    description: Mapped[str | None] = mapped_column(Text)
    raw: Mapped[dict[str, Any]] = mapped_column(JSONB, nullable=False)
    garmin_supplement: Mapped[dict[str, Any] | None] = mapped_column(JSONB)
...
class DailySummary(Base):
    ...
    training_readiness_score: Mapped[int | None] = mapped_column(SmallInteger)
    training_readiness_level: Mapped[str | None] = mapped_column(Text)
    vo2_max_running: Mapped[float | None] = mapped_column(REAL)
    vo2_max_cycling: Mapped[float | None] = mapped_column(REAL)
    ...
    respiration_avg: Mapped[float | None] = mapped_column(REAL)
    stress_max: Mapped[int | None] = mapped_column(SmallInteger)
